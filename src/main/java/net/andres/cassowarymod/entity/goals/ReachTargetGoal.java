...
public abstract class ReachTargetGoal extends Goal {

    protected final AnimatedTCreature mob;
    protected final double speedModifier;
    protected final boolean followingEvenIfNotSeen;
    protected int ticksUntilNextPathRecalculation;

    protected ReachTargetGoal(AnimatedTCreature mob, double speedModifier, boolean followingEvenIfNotSeen) {
        this.mob = mob;
